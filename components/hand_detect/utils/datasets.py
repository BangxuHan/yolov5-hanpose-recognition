...
from components.hand_detect.utils.utils import xyxy2xywh, xywh2xyxy
...
class LoadImagesAndLabels(Dataset):  # for training/testing
    def __init__(self, path, img_size=416, batch_size=16, augment=False, hyp=None, rect=False, image_weights=False,
        ...
        try:
            ...
            raise Exception('Error loading hand from %s. See %s' % (path, help_url))
...
def reduce_img_size(path='../hand/sm4/images', img_size=1024):  # from utils.datasets import *; reduce_img_size()
...
def convert_images2bmp():  # from utils.datasets import *; convert_images2bmp()
    ...
    for path in ['../hand/sm4/images', '../hand/sm4/background']:
    ...
    for file in ['../hand/sm4/out_train.txt', '../hand/sm4/out_test.txt']:
        with open(file, 'r') as f:
            lines = f.read()
...
def recursive_dataset2bmp(dataset='../hand/sm4_bmp'):  # from utils.datasets import *; recursive_dataset2bmp()
...
def imagelist2folder(path='hand/coco_64img.txt'):  # from utils.datasets import *; imagelist2folder()
